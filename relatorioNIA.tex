...
\begin{document}
  ...
  A CNN atingiu $0{,}70$ de acurácia na validação e $0{,}60$ no teste. A Figura~\ref{fig:cnn_curves} apresenta as curvas de treinamento, nas quais se observam a convergência estável do modelo e um leve \textit{overfitting} a partir da vigésima época, comportamento esperado dado o tamanho reduzido do conjunto de treino. A Figura~\ref{fig:cnn_cm} mostra a matriz de confusão na validação: os gêneros \textit{metal} e \textit{classical} foram os mais bem classificados (F1 de $0{,}93$ e $0{,}82$, respectivamente), enquanto \textit{rock} e \textit{country} concentraram os maiores erros (F1 de $0{,}53$ e $0{,}54$), sendo frequentemente confundidos entre si e com \textit{jazz}.
  ...
  \end{figure}
	...
	\begin{table}[h]
		...
		\begin{tabular}{lcc}
			...
			CNN  & 0.70 & 0.60 \\ % CNN sem BatchNorm
			\bottomrule
		\end{tabular}
	\end{table}
