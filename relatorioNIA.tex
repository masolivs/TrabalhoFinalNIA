...
\begin{document}
	...
	Diversos estudos exploraram a classificação de gênero musical...
	...
	A Convolutional Neural Network foi implementada com Keras...
	...
	\begin{table}[h]
		...
		\begin{tabular}{lcc}
			...
			CNN  & 0.000 & 0.000 \\ % [PESSOA C preenche]
			\bottomrule
		\end{tabular}
	\end{table}
	...
	\begin{thebibliography}{99}
		...
		\bibitem{ref3}
		% [PESSOA C adiciona referência sobre CNN/espectrograma]
		SOBRENOME, Nome. Título do artigo. \textit{Nome da Revista}, Ano.
